...
const ManagerCourseProgressPage = () => {
        ...
        <div className="min-h-screen py-10 md:py-14">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <StatCard title="Enrolled Learners" value={totalStudents} icon={Users} color="purple" subtitle="Active students" />
                ...
                <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm space-y-6">
                    ...
                    {filteredEnrollments.length > 0 ? (
                        ...
                        <div className="text-center py-12 bg-slate-50 dark:bg-slate-950/60 rounded-2xl border border-slate-200 dark:border-slate-800">
                            ...
                            <p className="font-bold text-slate-700 dark:text-slate-300 text-sm">No Enrolled Learners Found</p>
                        </div>
                    )}
                </div>
            </div>
...
export default ManagerCourseProgressPage;