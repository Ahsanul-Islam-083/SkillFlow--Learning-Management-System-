...
const ManagerEditCoursePage = () => {
    ...
    const [activeTab, setActiveTab] = useState("curriculum"); // "curriculum" | "quizzes" | "details"
    ...
    const handleSaveAll = async () => {
        ...
        try {
            ...
            // 1. Process Lessons (POST new, PUT existing)
    ...
    return (
        <div className="min-h-screen py-10 md:py-14">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
                ...
                {statusMessage.text && (
                    <div
                        className={`p-4 rounded-2xl text-xs flex items-center gap-2 ${statusMessage.type === "success"
                ...
                <div className="flex items-center gap-2 p-1 bg-slate-100 dark:bg-slate-800 rounded-2xl w-fit">
                    ...
                    >
                        <Layers className="w-4 h-4" /> Lectures & Curriculum ({lessons.length})
                    </button>
                    <button
                    ...
                    >
                        <HelpCircle className="w-4 h-4" /> Quizzes & MCQs ({quizzes.length})
                    </button>
                    <button
                    ...
                    >
                        <FileText className="w-4 h-4" /> Course Metadata
                    </button>
                </div>
                ...
                {activeTab === "curriculum" && (
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            <h2 className="font-bold text-base text-slate-900 dark:text-white">Curriculum Lessons</h2>
                            <button
...
export default ManagerEditCoursePage;